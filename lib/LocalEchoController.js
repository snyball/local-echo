...
export default class LocalEchoController {
  constructor(term = null, options = {}) {
    ...
    this._useContinuationPrompt = true;
    this._termSize = {
      cols: 0,
      rows: 0,
    };
  ...
  setUseContinuationPrompt(what) {
    this._useContinuationPrompt = what;
  }
  ...
  handleData(data) {
    ...
    if (ord == 0x1b) {
      ...
      switch (data) {
        case "\r": // ENTER
          if (this._useContinuationPrompt && isIncompleteInput(this._input)) {
